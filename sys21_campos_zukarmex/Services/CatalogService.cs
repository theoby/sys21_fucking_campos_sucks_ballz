...
public class CatalogService : ICatalogService
{
    ...
    public Task<ValidationResult> ValidateAsync<T>(T entity) where T : class
    {
            ...
            switch (entity)
            {
                case Almacen almacen:
                    if (string.IsNullOrWhiteSpace(almacen.Nombre))
                        result.Errors.Add("El nombre del almac�n es requerido");
                ...
                case Articulo articulo:
                    if (string.IsNullOrWhiteSpace(articulo.Nombre))
                        result.Errors.Add("El nombre del art�culo es requerido");
                ...
                case Lote lote:
                    ...
                    if (lote.IdCampo <= 0)
                        result.Errors.Add("El campo es requerido");
                    if (lote.Hectareas <= 0)
                        result.Errors.Add("Las hect�reas deben ser mayor a 0");
                    break;
        ...
        catch (Exception ex)
        {
            ...
            result.Errors.Add($"Error de validaci�n: {ex.Message}");
        }
        ...
        try
        {
            ...
            if (localResult > 0)
            {
                ...
                try
                {
                    ...
                    {
                        Success = true,
                        Message = "Guardado localmente. Se sincronizar� cuando est� disponible la conexi�n.",
                        Data = entity
                    };
                }
                catch
        ...
        try
        {
            ...
            if (localResult > 0)
            {
                ...
                try
                {
                    ...
                    {
                        Success = true,
                        Message = "Eliminado localmente. Se sincronizar� cuando est� disponible la conexi�n.",
                        Data = true
                    };
                }
                catch
    ...
    /// <summary>
    /// Sincronizaci�n completa forzada con borrado e inserci�n completa de todas las tablas
    /// </summary>
    ...
    /// <summary>
    /// Verificar integridad de todas las tablas despu�s de sincronizaci�n
    /// </summary>
